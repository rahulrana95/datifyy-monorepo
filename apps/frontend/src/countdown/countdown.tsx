...
const Countdown: React.FC = () => {
    ...
    return (
        <header>
                    ...
                    <Flex direction="column" gap="6" align="center" className="coming-soon-content">
                        ...
                        <Card variant="ghost" className="waitlist-card">
                            ...
                            <Form.Root className="waitlist-form">
                                ...
                                <Button variant="solid" className="submit-button" onClick={handleAddToWaitlist}>
            ...
            <Features />
            <Footer />
            <ToastC open={open} setOpen={setOpen} type='error' desc='' title='Thanks for joining the waitlist.' />
