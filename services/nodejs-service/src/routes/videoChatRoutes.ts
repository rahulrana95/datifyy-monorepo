...
import { createVideoChatSessions, getNextAvailableUser, getVideoChatSessions } from "../controllers/videoChatController";
...
router.get("/events/:eventId/video-chat-session", getVideoChatSessions); // Use createEvent function to handle this route
